...
class Gateway extends AbstractGateway
{
    ...
    /**
     * Method not supported by AfterPay
     * @param array $options
     *
     * @return void
     * @throws \Exception
    ...
    {
        throw new \Exception('completeAuthorize not suypported');
    }
    ...
    {
        throw new \Exception('deleteCard not suypported');
    }
    ...
    {
        throw new \Exception('completePurchase not suypported');
    }
    ...
    {
        throw new \Exception('authorize not suypported');
    }
    ...
    {
        throw new \Exception('createCard not suypported');
    }
    ...
    {
        throw new \Exception('updateCard not suypported');
    }
}
